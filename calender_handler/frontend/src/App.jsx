...
function HomeView() {
  ...
  const normalized = useMemo(() => {
    return items.map((it) => {
      ...
      const dueAt =
        a.due_at ||
        it.due_at ||
        (it.submission && it.submission.due_at) ||
        null;
      ...
      return {
        ...
        needsGradingCount:
          typeof it.needs_grading_count === "number"
            ? it.needs_grading_count
            : null,
  ...
  const flagsById = useMemo(
    () => buildFlagsMap(assignmentsWithMeta),
    [assignmentsWithMeta],
  );
  ...
  const todayPlan = useMemo(() => {
    ...
    const pool = showTA
      ? assignmentsWithMeta
      : assignmentsWithMeta.filter(
          (x) =>
            !(typeof x.type === "string" && x.type.toLowerCase() === "grading"),
        );
  ...
  return (
    <div
      style={{ width: "100%", padding: "32px 16px", fontFamily: "system-ui" }}>
          ...
          return (
            <div
              ...
              <div
                ...
                <div
                  className="corner"
                  style={{ textAlign: "right", color: "#555", fontSize: 13 }}>
                  {/*<div><b>{x.type}</b></div>*/}
      ...
      <footer>
        ...
        <ul className="footer-links">
          <li className="footer-link">
            <Link to="/">Canvas Companion</Link>
          </li>
          <li className="footer-link">
            <Link to="/log-in">Sign Out</Link>
          </li>
        </ul>
      </footer>
    </div>
...
function Overview({ todayPlan, flagsById }) {
  return (
    <div
      ...
      <section
        style={{ backgroundColor: "#0b63ff", padding: 12, borderRadius: 10 }}>
        <MonthlyView />
      </section>
      <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
        <section
          style={{ backgroundColor: "#ff6b6b", padding: 12, borderRadius: 10 }}>
          <Streak />
        </section>
        <section
          style={{ backgroundColor: "#ffd54f", padding: 12, borderRadius: 10 }}>
